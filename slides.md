...
layout: two-cols
class: 'pa-5'
title: Client sending int bits 
---
<br>
<br>

```c {all|3,6|7|7|4,9|10|11|7-12}
...
<h1 style="text-align: center">Sending an Int to Server</h1>
<br>
...
<h1 style="text-align: center">Sending Chars to Server</h1>
<br>
...
<ul>
	...
	<li v-click="2">
		All local variables are static, therefore automatically initialized to 0.
	</li>
	<li v-click="3">
...
```c {all|3-4|6|8|10-11|12-13|14|15}
