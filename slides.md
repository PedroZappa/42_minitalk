...
<div class="mr-7">
	...
	<li v-click="2">
		However, if that <span class="color-blue">signal type</span> is being <span class="color-red">blocked</span>, it may remain <span class="color-yellow">pending indefinitely</span>.
	</li>
	<br>
	<hr v-click="3">
	<p v-click="3">
...
<h1 class="text-center">minitalk Protocol</h1>
...
<div v-click="5" class="note">
	...
	<li v-click="6">
		<span class="color-blue">SIGUSR1</span> signals that a bit was successfully received.
	</li>
	<li v-click="7">
		<span class="color-blue">SIGUSR2</span> signals that the end of message was received, transmission is over.
	</li>
</div>
...
.note {
	@apply flex-col border-2 border-green rounded-3xl w-80 pa-5
}
</style>
